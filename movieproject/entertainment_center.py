...
big_hero = media.Movie(
                       # this the instance of Big Hero it will showcase the arguments
...
'''fresh_tomatoes file will take in a list aka array of movies to display'''
'''in a webpage using the open_movies_page function'''
